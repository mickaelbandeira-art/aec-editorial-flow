...
async function verify() {
    console.log("Verifying 'RH' product access for mickael.bandeira@aec.com.br...");
    ...
    if (error) {
        ...
        if (user.produtos_acesso.includes('rh')) {
            console.log("SUCCESS: User has access to 'rh'.");
        } else {
            console.error("FAILURE: User missing 'rh' access.");
        }
    }
}
